...
<script type="text/javascript">
	...
	function openPasswordModifyDialog(){
		...
		url="${pageContext.request.contextPath}/admin/blogger/modifyPassword?id=${sessionScope.loginBlogger.id}";
	}
	...
	<table style="padding: 5px" width="100%">
		<tr>
			...
			<td valign="bottom" align="right" width="50%">
				<span style="font-size: small; ">&nbsp;&nbsp;<strong>欢迎：</strong>${sessionScope.loginBlogger.name }</span>
...
<div id="dlg" class="easyui-dialog" style="width:400px;height:200px;padding: 10px 20px"
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		<tr>
   			<td>用户名：</td>
   			<td><input type="text" id="userName" name="name" readonly="readonly" value="${sessionScope.loginBlogger.name }" style="width: 200px"/></td>
   		</tr>
   		<tr>
   			<td>新密码：</td>
